...
export default function FeaturesSection() {
	...
	return (
		<section
			id="features"
			className=" py-16 md:py-32 dark:bg-transparent relative overflow-hidden"
		>
			{/* Horizontal bar */}
						...
						<div className="relative z-10 grid grid-cols-6 gap-3">
							<Card className="relative col-span-full flex overflow-hidden lg:col-span-2">
								<CardContent className="relative m-auto size-fit pt-6">
									<div className="relative flex mx-auto h-24 w-56 items-center">
										<svg
									...
									<div className="relative z-10 mt-6 space-y-2 text-center">
										<h2 className="group-hover:text-secondary-950 text-lg font-bold transition dark:text-white">
											100% Personalizable
										</h2>
										<p className="text-foreground">
											Rently adapts to your workflow instead of forcing you into
											someone else’s system. Set your own rules, automations,
											reminders, pricing—literally everything bends to how you
											run your rental biz.
										</p>
									</div>
								</CardContent>
								...
								<CardContent className="pt-6">
									<div className="relative mx-auto flex aspect-square size-32 rounded-full border before:absolute before:-inset-2 before:rounded-full before:border dark:border-white/10 dark:before:border-white/5">
										<svg
											...
											xmlns="http://www.w3.org/2000/svg"
										>
											<path d="M12 2a5 5 0 00-5 5v3H6a2 2 0 00-2 2v8a2 2 0 002 2h12a2 2 0 002-2v-8a2 2 0 00-2-2h-1V7a5 5 0 00-5-5zm-3 8V7a3 3 0 016 0v3H9zm3 4a2 2 0 11.001 4.001A2 2 0 0112 14z" />
										</svg>
									</div>
									<div className="relative z-10 mt-6 space-y-2 text-center">
										<h2 className="group-hover:text-secondary-950 text-lg font-bold transition dark:text-white">
										...
										<p className="text-foreground">
											Tenant info, payments, agreements—all encrypted and
											protected from snoopers. You get bank-grade security
											without doing any nerdy setup rituals.
										</p>
									</div>
								</CardContent>
							</Card>
								...
								<CardContent className="pt-6">
									...
									<div className="relative z-10 mt-14 space-y-2 text-center">
										<h2 className="text-lg font-bold transition">
											Manage everything in minutes
										</h2>
										<p className="text-foreground">
											Collect payments, handle maintenance, update listings,
											approve tenants—no lag, no chaos. Rently cuts the boring
											stuff so you stay in control without drowning in tasks.
										</p>
									</div>
								</CardContent>
							</Card>
								...
								<CardContent className="grid pt-6 sm:grid-cols-2">
									<div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
										...
										<div className="space-y-2">
											...
											<p className="text-foreground">
												Track occupancy, overdue payments, maintenance requests,
												upcoming renewals—all from one dashboard. No guessing.
												No spreadsheets from the Jurassic era.
											</p>
										</div>
									</div>
