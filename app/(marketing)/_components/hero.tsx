				...
				<div className="mx-auto max-w-4xl text-center flex-1 flex flex-col justify-center">
					...
					>
						...
						>
							...
							Rentals managed <br />
							<strong>smarter</strong> <span>&</span> <em>effortlessly</em>
							{/* <em className="italic">smarter</em> */}
						</h1>
						{/* Simplify Rentals. Manage Smarter, Not Harder. */}
					</motion.div>
					...
					>
						Effortlessly manage rent collection and maintenance — all from one
						smart, centralized platform
					</motion.p>
					...
					>
						...
						<div className="flex items-center justify-center">
							<Link href="/signup">
								<div className="group  border border-border bg-card gap-2 h-15 flex items-center p-2.5 rounded-full">
									...
									<div className="text-muted-foreground group-hover:ml-4 ease-in-out transition-all size-6 flex items-center justify-center rounded-full border-2 border-border">
										...
										>
											<CircleArrowRight className="size-6 text-muted-foreground/90" />
										</motion.div>
									</div>
								</div>
							</Link>
