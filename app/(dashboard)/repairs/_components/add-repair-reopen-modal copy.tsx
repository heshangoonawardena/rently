...
export default function AddRepairReopenModal({
	repairRequestId,
	currentStatus,
	children,
	...
	return (
		...
		>
			...
			<DialogContent className="sm:max-w-xl">
				<DialogHeader>
					<DialogTitle>Reopen Repair Request</DialogTitle>
					<DialogDescription>
						Log a reopen note and move this resolved request to a reopen state
						status.
					</DialogDescription>
				</DialogHeader>
