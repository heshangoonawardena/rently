...
export function ThemeCustomizer({ open, onOpenChange }: ThemeCustomizerProps) {
	...
	const [selectedRadius, setSelectedRadius] = React.useState("0.75rem");
					...
					<div className="flex-1 overflow-y-auto">
						...
						>
							<div className="py-2">
								...
								{/* <TabsList className="grid w-full grid-cols-2 rounded-none h-12 p-1.5">
                  <TabsTrigger value="theme" className=" data-[state=active]:bg-primary data-[state=active]:text-primary-foreground"><Palette className="h-4 w-4 mr-1" /> Theme</TabsTrigger>
                  <TabsTrigger value="layout" className=" data-[state=active]:bg-primary data-[state=active]:text-primary-foreground"><Layout className="h-4 w-4 mr-1" /> Layout</TabsTrigger>
                </TabsList> */}
							</div>
...
export function ThemeCustomizerTrigger({ onClick }: { onClick: () => void }) {
	...
	return (
		<Button
			...
			size="icon"
			className={cn(
				"fixed top-1/2 -translate-y-1/2 h-12 w-12 rounded-full shadow-lg z-50 bg-primary hover:bg-primary/90 text-primary-foreground ",
